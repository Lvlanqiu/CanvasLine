(function($, window) {
	...
	var itemTemplate = '<div class="mui-slider-item mui-zoom-wrapper {{className}}"></div><div class="mui-zoom-scroller"><img ontouchstart="gtouchstart(this)" ontouchmove="gtouchmove()" ontouchend="gtouchend(this)" src="{{src}}" data-preview-lazyload="{{lazyload}}" style="{{style}}" class="mui-zoom"></div></div>';
...
//开始按 
var gtouchstart = function(_this){
	...
	plus.nativeUI.actionSheet({
		...
		function(e) {
			if (e.index == 1) {
				...
				a.setAttribute('download',dt+'.png');
				a.click();
			}
		}
	);
